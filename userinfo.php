...
<tr>><th>Computer Name</th><th>username</th>><th>Family</th><th>RAM</th>><th>asset</th>><th>notes</th><th>timestamp</th>
</tr>
...
echo <<<EOF
        <td>$computername</td><td>$username</td><td>$computerfamily</td><td>$ram</td><td>$asset</td><td><input value="$notes"></td><td>$timestamp</td>
        <td><input type="button" value="More Info" onclick="window.open('./userinfo.php',name='userinfo')"</tr>
    </tr>
EOF;
/*
	...
	<td>$bailout</td><td>$bailpass</td><td>$modification</td><td>$retirement</td><td><input value="$notes"></td><td>$timestamp</td>
*/
